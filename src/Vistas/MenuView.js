            ...
            <View style={[styles.sfc13888e, { flexDirection: "row" }]}>
              ...
              <View style={styles.sf3785ddd}>
                <TouchableOpacity onPress={this.onPressSets}>
                  ...
                  <Text style={styles.s73b11ae0}>CONJUNTOS</Text>
                </TouchableOpacity>
              </View>
            </View>
              ...
              <View style={[styles.s923b1cd6, { flexDirection: "row" }]}>
                ...
                <View style={styles.s4d5fab9b}>
                  <View style={{flex:1, flexDirection: "row" }}>
                    <View style={{flex:1,backgroundColor: `rgba(48, 204, 108, 1)`}}>
                      <View  style={{flex:1,backgroundColor: `rgba(33, 33, 33, 1)`,borderTopLeftRadius:50}}/>
                    </View>
                    <View style={{    justifyContent: 'center',  alignItems: 'center',flex:2}}>
                      <TouchableOpacity onPress={this.onPressLogOut}>
                        <Icon  style={{ color: "#ffffff",fontSize:40 }} type="FontAwesome" name='cog'/>
                      </TouchableOpacity>
                    </View>
                    <View style={{flex:1,backgroundColor: `rgba(213, 56, 36, 1)`}}>
                      <View  style={{flex:1,backgroundColor: `rgba(33, 33, 33, 1)`,borderTopRightRadius:50}}/>
                    </View>
                  </View>
                </View>
...
const styles = StyleSheet.create({
  s98059f0a: { height: 100, width: 100, resizeMode: 'contain' },
  sda221942: {
  ...
  s8f443a62: { height: 100, width: 100,resizeMode: 'contain' },
  s73b11ae0: {
    color: `rgba(255, 255, 255, 1)`,
    fontSize: 15,
    textAlign: 'center',
  ...
  sfc68a166: { height: 100, width: 100, resizeMode:'contain' },
  sedb32a67: {
    color: `rgba(255, 255, 255, 1)`,
    fontSize: 15,
    fontWeight: `bold`,
  ...
  sc36b1c8e: { height: 100, width: 100, resizeMode:'contain' },
  s8c9efc64: {
    color: `rgba(255, 255, 255, 1)`,
    fontSize: 15,
    fontWeight: `bold`,
  ...
  s923b1cd6: { backgroundColor: `rgba(0, 0, 0, 1)`, flex: 0.3 },
  s8ab8b2a6: {
    backgroundColor: `rgba(0, 0, 0,1)`,
    borderWidth: 2,
    flex: 1,
